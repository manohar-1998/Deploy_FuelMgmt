...
import { getMaintanencesearch, getMaintenanceSheetformanager } from 'src/Apicalls';
toast.configure();
function Maintanencesearch() {
    ...
    const preload = (apiUrl, filter) => {
        getMaintenanceSheetformanager(uid,apiUrl, filter).then((values) => {
...
export default Maintanencesearch;
