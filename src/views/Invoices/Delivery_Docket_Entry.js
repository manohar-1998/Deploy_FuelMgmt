...
import { createdocket } from 'src/Apicalls';
import { isAuthenticated } from 'src/Auth';
function Delivery_Docket_Entry() {
    ...
    const notify = () => {
        toast.success(<h3>Docket Created Successfully</h3>, {
    ...
    const docketcreate = (event) => {
        ...
        createdocket(docket).then((data) => {
            console.log("Docket check=",docket)
            if (data.error) {
...
export default Delivery_Docket_Entry;
const headerstyle = {
    textAlign: "center",
    color: "grey",
    fontSize: "24px",
